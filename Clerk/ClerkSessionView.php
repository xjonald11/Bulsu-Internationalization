<?php
    include_once 'ClerkSession.php'; // Include appropriate session file
    ...
    // Add any additional logic specific to HeadSession if needed
        ...
        <div class="row flex-grow-1">
            <div class="col-md-2 bg-light">
                ...
                <li><a href="Registration.php">Add user</a></li>
                    ...
                    <li><a href="HeadSessionView.php">View Events</a></li>
                </ul>
            </div>
            <div class="col-md-10">
    <div id="content">
