...
// $servername = "localhost";
// $username = "u673355866_cmbulsu";
// $password = "Ra#$324gfSd$@D";
// $dbname = "u673355866_cmbulsu";
...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO uploaded_files (file_name, description, status, file_content) VALUES (:file_name, :description, :status, :file_content)");
