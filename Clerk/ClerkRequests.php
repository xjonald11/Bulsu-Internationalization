...
include_once 'ClerkSession.php'; // Assuming you have a ClerkSession.php file
...
$result = mysqli_query($con, "SELECT * FROM file_requests");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="UploadFile.php">Add New File</a>
                        <a class="collapse-item" href="View.php">View File</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="ClerkRequests.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1>View and Process Requests</h1>
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>
                ...
                <button type='submit' class='btn btn-warning' name='pending'>Pending</button>
              </td>";
        echo "</tr>";
    }
    ?>
