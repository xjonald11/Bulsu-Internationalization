<?php
    ...
    $profileQuery = mysqli_query($con, "SELECT profile_image FROM user WHERE email = '$uname'") or die(mysqli_error($con));

    // Fetch partner profiles from the database
    $result = mysqli_query($con, "SELECT * FROM partner_profiles");

    // Initialize an empty array to store partner data
    $partnerData = [];

    // Check if there are any partner profiles
    if (mysqli_num_rows($result) > 0) {
        // Loop through each row and store partner details in an array
...
<body id="page-top">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
        ...
        $profileImage = isset($profileData['profile_image']) ? $profileData['profile_image'] : 'image/user.png';
        ?>
        <img class="img-profile rounded-circle" src="<?php echo $profileImage; ?>" alt="Profile Picture">
    </a>
    <!-- Dropdown - User Information -->
    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
        aria-labelledby="userDropdown">
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#uploadProfileModal">
        ...
        <div class="modal-content">
            ...
            <form action="uploadProfile.php" method="post" enctype="multipart/form-data">
                ...
                <div class="container mt-5">
                    <h2 class="text-center">Partner Profiles</h2>
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <p>Department Head: <?php echo $partner['department_head']; ?></p>
                                        <p>Description: <?php echo $partner['partner_description']; ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
