<?php
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Sanitize and get partner profile details from $_POST
        $partner_name = mysqli_real_escape_string($con, $_POST['partner_name']);
        $partner_description = mysqli_real_escape_string($con, $_POST['partner_description']);

        // Insert partner profile into database
        $insertqry = mysqli_query($con, "INSERT INTO partner_profiles (partner_name, partner_description) VALUES ('$partner_name', '$partner_description')") or die(mysqli_error($con));

        if ($insertqry) {
            echo "<script>alert('Partner profile added successfully!');</script>";
        } else {
...
<body id="page-top">
    ...
    <div class="container mt-5">
        <h2 class="text-center">Add Partners Profile</h2>
        <form action="index.php" method="post">
            <div class="form-group">
                <label for="partner_name">Partners Name</label>
            ...
            <div class="text-center">
                <input type="submit" class="btn btn-primary" name="submit" value="Add Partner Profile">
            </div>
        </form>
    </div>
    <!-- /.container-fluid -->
